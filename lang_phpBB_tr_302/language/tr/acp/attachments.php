...
$lang = array_merge($lang, array(
	...
	'ALLOWED_FORUMS'					=> 'İzin verilmiş forumlar',
	'ALLOWED_FORUMS_EXPLAIN'			=> 'Forumlardaki seçilmiş (veya tümü seçiliyse) tanımlanan uzantılar cevaplanabilir.',
	...
	'ATTACH_MAX_PM_FILESIZE_EXPLAIN'	=> 'Özel mesaj eklentilerinde her kullanıcı için mevcut en fazla sürücü alanı, 0 ile sınırsız olur.',
  ...
  'CHECK_CONTENT_EXPLAIN'      => 'Bazı tarayıcılar yüklenen dosyalar için geçersiz bir dosya tipi (mimetype) varsayarak aldatabilirler. Bu seçenek kabul edilmeyen bunun gibi olası dosyalardan emin olmanızı sağlar.',
	...
	'MAX_ATTACHMENTS'				=> 'Her mesajdaki en fazla eklenti miktarı',
	'MAX_ATTACHMENTS_PM'			=> 'Her özel mesajdaki en fazla eklenti miktarı',
