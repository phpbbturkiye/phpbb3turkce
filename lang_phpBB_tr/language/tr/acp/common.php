...
$lang = array_merge($lang, array(
  ...
  'PURGE_CACHE_EXPLAIN'   => 'Tüm önbellek ile ilgili ögeleri temizler; bu, önbelleklenen herhangi şablon dosyalarını ya da sorgularını kapsar.',
	...
	'RESYNC_POST_MARKING'	=> 'Noktalı başlıkları yeniden senkronize et',
	'RESYNC_POST_MARKING_CONFIRM'	=> 'Noktalı başlıkları yeniden senkronize etmek istediğinize emin misiniz?',
 	'RESYNC_POST_MARKING_EXPLAIN'	=> 'İlk önce tüm başlıkların işaretlerini kaldırın ve o zaman geçmişteki altı ay zarfında etkin olan işaretli başlıklar doğru şekilde görülecektir.',
...
$lang = array_merge($lang, array(
  ...
  'LOG_TOPIC_DISAPPROVED' => '<strong>“%1$s” isimli başlık şu sebepten dolayı onaylanmadı</strong><br />%2$s',
	...
	'LOG_USERS_APPROVED'	=> '<strong>Kullanıcı Grubuna katılımlar onaylandı</strong> %1$s<br />» %2$s',
