...
$lang = array_merge($lang, array(
	...
	'SYSTEM_TIMEZONE_EXPLAIN'         => 'Giriş yapmayan kullanıcılara (misafirler, botlar) gösterilmek için kullanılacak zaman dilimi. Giriş yapan kullanıcılar kendi zaman dilimlerini kayıt esnasında ayarlayabilirler ve kullanıcı kontrol panelinden değiştirebilirler.',
...
$lang = array_merge($lang, array(
  ...
  'ALLOW_POST_FLASH_EXPLAIN'         => 'Eğer mesajlarda <code>[FLASH]</code> BBCode etiketine izin verilmezse, bunun dışında izin sistemi kontrollerindeki kullanıcılar <code>[FLASH]</code> BBCode etiketi kullanabilir.',
	...
	'BUMP_INTERVAL_EXPLAIN'			=> 'Bir başlıktaki son mesaj ile bu başlığı darbeleme arasında geçecek olan dakika, saat ya da gün sayısı. Bu özelliği kapatmak için 0 değeri verin.',
...
$lang = array_merge($lang, array(
	...
	'NEW_MEMBER_GROUP_DEFAULT_EXPLAIN'	=> 'Eğer evet olarak ayarladıysanız, ve yeni bir üyenin mesaj sınırı belirlendiyse, yeni kayıtlı kullanıcılar sadece <em>Yeni Kayıtlı Kullanıcılar</em> grubuna yerleştirilmeyecektir, fakat bu grup ayrıca onların varsayılan grubu olacaktır. Eğer bir gruba varsayılan olarak rütbe ve/veya avatar tanımlamak isterseniz bu işlem kullanışlı gelebilir.',
...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	...
	'REG_LIMIT_EXPLAIN'         => 'Kullanıcıların kayıt esnasındaki anti-spambot görevini çözmek için oturumun kilitlenmesinden önce yapabilecekleri girişimlerin sayısı.',
...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_SELECT_EXPLAIN'            => 'Açılan menü mesaj panosu tarafından tanınan eklentileri tutar. Gri kayıtlar şu anda kullanılabilir değildir ve kullanmadan önce ayarlama gerektirebilir.',
	'CAPTCHA_CONFIGURE'                  => 'Eklentileri ayarla',
	'CAPTCHA_CONFIGURE_EXPLAIN'            => 'Seçilen eklenti için ayarları değiştir.',
	'CONFIGURE'                        => 'Ayarla',
...
$lang = array_merge($lang, array(
  ...
  'FORM_SID_GUESTS_EXPLAIN'      => 'Eğer aktifse, oturum-dışı tutulacak misafirlere form işaret gösterecektir. Bu, bazı ISSler için problemlere neden olabilir.',
	...
	'MAX_LOGIN_ATTEMPTS_EXPLAIN'   => 'Kullanıcının yaptığı hatalı girişler bu sayıyı geçtikten sonra kullanıcıdan ayrıca anti-spambot görevini çözmesi istenecektir.',
