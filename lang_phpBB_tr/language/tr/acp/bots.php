...
$lang = array_merge($lang, array(
	...
	'BOT_EDIT_EXPLAIN'	=> 'Bu bölümde, yeni robotlar ekleyebilir, var olan robot bilgilerini güncelleyebilirsiniz. Eşleşme için ajan koşulu veya bir ya da birden fazla IP adresleri(belirli bir aralığa sahip adreslerde olabilir) tanımlayabilirsiniz. Ajan koşullarını veya adresleri düzenlerken dikkatli olmalısınız. Forum kullanımında robotları dilini ve stilini buradan değiştirebilirsiniz. Robotlar için basit stiller ayarlanması ile robotların bandwith kullanımını azaltmasına katkıda bulunabilirsiniz. Özel kullanıcı robotları için doğru izinleri ayarlamayı unutmayınız.',
	'BOT_LANG'			=> 'Robot Dili',
